...
public class HelpFrame extends JFrame {
	...
	private void setHelpText() {
		helpInfo.setText("<html> Ну здарова. Раз ты сюда пришел, значит еще не вкурсах что здесь творится. <br>" 
						...
						+"Shift + ЛКМ - можно выделить еще одного юнита, либо снять выделение с уже выделенного<br>"
						+"Shift + Зажав ЛКМ - можно выделить еще несколько юнитов<br>"
						+"ПКМ - отдать приказ юниту немедленно. Также очищает очередь задач<br>"
						+"ПКМ по выделенному юниту откроет контестное меню.<br>"
						+"Shift + ПКМ - добавить юниту задачу<br>"
						+"Зажав колесико можно подвигать карту<<br>"
						+"Нажав на 4-ую клавишу мыши можно заспаунить юнита (стоимость одного 100 единиц продовольствия)</em><br><br>"
						...
						+"Для этого можешь спаунить юнитов, и направлять их на ресурсы."
						+"Поселенцы умеют искать ресурсы, используя для этого спиральный поиск."
